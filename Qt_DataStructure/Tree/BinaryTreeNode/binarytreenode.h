...
public:
    ...
    const BinaryTreeNode<T>* GetLeftChild() const;  // 返回该节点的左孩子指针
    const BinaryTreeNode<T>* GetRightChild() const; // 返回该节点的右孩子指针
...
// 返回该节点的左孩子指针
template<typename T>
const BinaryTreeNode<T>* BinaryTreeNode<T>::GetLeftChild() const
{
    return this->m_leftNode;
}
// 返回该节点的右孩子指针
template<typename T>
const BinaryTreeNode<T>* BinaryTreeNode<T>::GetRightChild() const
{
